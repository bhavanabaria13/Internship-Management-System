        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-foreground/60">
              <li><a  href="https://etherauthority.io/smart-contract-audit/" target="_blank">Smart Contract Audit</a></li>
              <li><a  href="https://etherauthority.io/smart-contract-development/" target="_blank">Smart Contract Development</a></li>
              <li><a  href="https://etherauthority.io/public-blockchain-development/" target="_blank">Public Blockchain Development</a></li>
              <li><a  href="https://etherauthority.io/kyc/" target="_blank">KYC</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
                ...
                <li>
                 <a  href="https://etherauthority.io/privacy-policy/" target="_blank">
                    Privacy Policy
                  </a>
                </li>
            
                <li>
                 <a  href="https://etherauthority.io/terms-of-service/" target="_blank">
                    Terms of Service
                  </a>
                </li>
              
              <li className="text-sm text-foreground/60"><a  href="https://etherauthority.io/disclaimers/" target="_blank">Disclaimers</a></li>
              <li className="text-sm text-foreground/60"><a  href="https://drive.google.com/drive/folders/1XGYG8TKR6pj-lnkA2KaiqhSeKv0Ms80p" target="_blank">EA Media Kit</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-sm text-foreground/60"><a  href="https://etherauthority.io/portfolio/" target="_blank">Portfolio</a></li>
              <li className="text-sm text-foreground/60"><a href="https://etherauthority.io/blog/" target="_blank">Blog</a></li>
              <li className="text-sm text-foreground/60"><a href="https://www.youtube.com/channel/UCOW2MNIhdrUsE_etsh9UpIQ" target="_blank">Videos</a></li>
