...
export default function Header({ onApplyClick, onAdminClick, onInternClick, onCareerClick, onContactClick }: HeaderProps) {
...
>
  ...
  />
          ...
          <nav className="hidden md:flex items-center gap-8 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            <a href="#benefits" className="text-sm font-medium tracking-wide hover:text-purple-400 transition-all duration-300 relative group py-1">
              Programs
            ...
            <Button 
              ...
              className="relative overflow-hidden hover:bg-white/10 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 group"
            >
